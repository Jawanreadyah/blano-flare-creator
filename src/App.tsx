                  ...
                  <>
                    ...
                    <div className="py-20 bg-black/50 backdrop-blur-sm">
                      <MarqueeAnimation
                        direction="left"
                        baseVelocity={-3}
                        className="bg-hurricane-red/10 text-white py-4 mb-4"
                      >
                        CREATING EXTRAORDINARY EXPERIENCES • INNOVATIVE SOLUTIONS • UNFORGETTABLE MOMENTS
                      </MarqueeAnimation>
                      <MarqueeAnimation
                        direction="right"
                        baseVelocity={-4}
                        className="bg-white/5 text-white py-4"
                      >
                        PREMIUM EVENT MANAGEMENT • TECHNICAL EXCELLENCE • CREATIVE DESIGN
                      </MarqueeAnimation>
                    </div>
                    <Projects />
                    <Concert />
