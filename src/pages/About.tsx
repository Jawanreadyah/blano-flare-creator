...
const ArtCard = ({ url, alt }: { url: string; alt: string }) => (
  <div className="w-72 h-32 mx-4 overflow-hidden rounded-2xl">
    <img 
      src={url} 
      alt={alt}
    ...
    <section className="relative py-32 bg-black min-h-screen overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative">
        ...
        <div className="grid md:grid-cols-2 gap-20 items-center mb-32">
          ...
          <div className="relative h-[600px] overflow-hidden rounded-2xl backdrop-blur-sm bg-black/20">
            <Marquee className="py-4" pauseOnHover vertical>
